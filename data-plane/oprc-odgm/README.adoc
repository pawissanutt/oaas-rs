...
* V2 event pipeline for reactive applications (per-entry triggers)
...
For comprehensive technical documentation on string IDs, granular storage, and V2 events, see: link:../../docs/TECHNICAL_OVERVIEW.md[Technical Overview]
