...
impl PackageServiceHandler for PackageSvcStub {
    ...
    ) -> Result<Response<oprc_grpc::proto::package::CreatePackageResponse>, Status> {
        Err(Status::unimplemented("create_package not implemented in CRM"))
    }
    ...
    async fn list_packages(
        ...
        Err(Status::unimplemented("list_packages not implemented in CRM"))
    }

    async fn delete_package(
        &self,
        _request: Request<oprc_grpc::proto::package::DeletePackageRequest>,
    ) -> Result<Response<oprc_grpc::proto::package::DeletePackageResponse>, Status> {
        Err(Status::unimplemented("delete_package not implemented in CRM"))
    }
    ...
    async fn report_deployment_status(
        ...
        Err(Status::unimplemented("report_deployment_status not implemented in CRM"))
    }
}
